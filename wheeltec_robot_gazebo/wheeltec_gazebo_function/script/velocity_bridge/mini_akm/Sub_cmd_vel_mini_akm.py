...
def set_mini_akm_velocity_steering(data):
    pub_vel_mini_akm_left_rear_wheel = rospy.Publisher('/wheeltec/mini_akm_left_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_akm_right_rear_wheel = rospy.Publisher('/wheeltec/mini_akm_right_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_akm_left_front_wheel = rospy.Publisher('/wheeltec/mini_akm_left_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_akm_right_front_wheel = rospy.Publisher('/wheeltec/mini_akm_right_front_wheel_velocity_controller/command', Float64, queue_size=1)
    ...
    pub_vel_mini_akm_left_front_wheel.publish(vlr)
    pub_vel_mini_akm_right_front_wheel.publish(vrr)
